...
''')
        ...
        self.assertEqual('detected go code. min version 1.16 is required. version 1.18 or above is recommended. we detected that you have version 1.15. see https://github.com/AmpereComputing/ampere-porting-advisor/blob/main/doc/golang.md for more details.', self.report.remarks[0].description)
...
''')
        ...
        self.assertEqual('detected go code. min version 1.16 is required. version 1.18 or above is recommended. we detected that you have version 1.16. see https://github.com/AmpereComputing/ampere-porting-advisor/blob/main/doc/golang.md for more details.', self.report.remarks[0].description)
...
''')
        ...
        self.assertEqual(1, len(self.report.remarks))
        self.assertEqual(ReportItem.POSITIVE, self.report.remarks[0].item_type)
        self.assertEqual('detected go code. min version 1.16 is required. version 1.18 or above is recommended. we detected that you have version 1.18. see https://github.com/AmpereComputing/ampere-porting-advisor/blob/main/doc/golang.md for more details.', self.report.remarks[0].description)
