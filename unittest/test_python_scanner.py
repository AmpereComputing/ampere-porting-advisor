...
class TestPythonScanner(unittest.TestCase):
    ...
    def test_scan_file_object_with_python_files_cause_language_version_remark(self):
        ...
        self.assertEqual(
            f'detected python code. min version 3.7.5 is required. we detected that you have version {runtime_version}. see https://github.com/AmpereComputing/ampere-porting-advisor/blob/main/doc/python.md for more details.',
